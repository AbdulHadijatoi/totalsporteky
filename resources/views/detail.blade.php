...
<body>
  ...
  {{-- @if (isset($setvar)) --}}
    ...
    <div class="table-container">
        <div class="text">
       <img src="{{ asset('storage/' . $detail_match->league->image) }}" style="width: 58px; height: auto; object-fit: cover;" alt="">
         ...
         <p style="margin-left:61px;"> {{ $detail_match->date_of_match}}</p> 
          ...
          <div class="additional-text"><img src="{{ asset('storage/team/' . $detail_match->home_image) }}" style="width: 123px; height: 117px; object-fit: cover;" alt="">
            <br>{{ $detail_match->home_name}}
          </div>
          <div class="middle-text"><span style="font-size:28px; font-weight:bold;"id="countdown"></span></div>
          <div class="right-text"><img src="{{ asset('storage/team/' . $detail_match->away_image) }}" style="width: 123px; height: 117px; object-fit: cover;" alt="">
