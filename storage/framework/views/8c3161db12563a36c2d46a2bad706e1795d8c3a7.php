...
<?php $__env->startSection('title', 'User Profile - Profile'); ?>
    ...
    <div class="card mb-4">
      ...
      <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
        <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
          <img src="<?php echo e(asset('assets/img/avatars/14.png')); ?>" alt="user image" class="d-block h-auto ms-0 ms-sm-4 rounded user-profile-img">
        </div>
...
<div class="row">
  <div class="col-md-12">
    <ul class="nav nav-pills flex-column flex-sm-row mb-4">
      ...
      <li class="nav-item"><a class="nav-link" href="<?php echo e(url('pages/profile-teams')); ?>"><i class='ti-xs ti ti-users me-1'></i> Teams</a></li>
      <li class="nav-item"><a class="nav-link" href="<?php echo e(url('pages/profile-projects')); ?>"><i class='ti-xs ti ti-layout-grid me-1'></i> Projects</a></li>
      <li class="nav-item"><a class="nav-link" href="<?php echo e(url('pages/profile-connections')); ?>"><i class='ti-xs ti ti-link me-1'></i> Connections</a></li>
    </ul>
  </div>
</div>
<!--/ Navbar pills -->
            ...
            <ul class="list-unstyled mb-0">
              ...
              <li class="mb-3">
                <div class="d-flex align-items-start">
                  <div class="d-flex align-items-start">
                    <div class="avatar me-2">
                      <img src="<?php echo e(asset('assets/img/avatars/10.png')); ?>" alt="Avatar" class="rounded-circle" />
                    </div>
                    <div class="me-2 ms-1">
            ...
            <ul class="list-unstyled mb-0">
              ...
              <li class="mb-3">
                <div class="d-flex align-items-center">
                  <div class="d-flex align-items-start">
                    <div class="avatar me-2">
                      <img src="<?php echo e(asset('assets/img/icons/brands/support-label.png')); ?>" alt="Avatar" class="rounded-circle" />
                    </div>
                    <div class="me-2 ms-1">
              ...
              <li class="mb-3">
                <div class="d-flex align-items-center">
                  <div class="d-flex align-items-start">
                    <div class="avatar me-2">
                      <img src="<?php echo e(asset('assets/img/icons/brands/figma-label.png')); ?>" alt="Avatar" class="rounded-circle" />
                    </div>
                    <div class="me-2 ms-1">
              ...
              <li class="mb-3">
                <div class="d-flex align-items-center">
                  <div class="d-flex align-items-start">
                    <div class="avatar me-2">
                      <img src="<?php echo e(asset('assets/img/icons/brands/vue-label.png')); ?>" alt="Avatar" class="rounded-circle" />
                    </div>
                    <div class="me-2 ms-1">
              ...
              <li class="mb-3">
                <div class="d-flex align-items-center">
                  <div class="d-flex align-items-start">
                    <div class="avatar me-2">
                      <img src="<?php echo e(asset('assets/img/icons/brands/twitter-label.png')); ?>" alt="Avatar" class="rounded-circle" />
                    </div>
                    <div class="me-2 ms-1">
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u493167285/domains/totalsporteky.com/public_html/resources/views/content/pages/pages-profile-user.blade.php ENDPATH**/ ?>