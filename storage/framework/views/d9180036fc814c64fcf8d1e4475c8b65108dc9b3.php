...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <ul class="menu-inner py-1">
    ...
    <?php if(isset($menu->name) && ($menu->name == 'Dashboards' || $menu->name == 'Matches' || $menu->name == 'Teams' || $menu->name == 'Blogs')): ?>
...
<?php elseif(auth()->user()->role == 'super-admin'): ?>
    <?php if(isset($menu->name) && ($menu->name == 'Dashboards' || $menu->name == 'Leagues')): ?>
        <li class="menu-item <?php echo e($activeClass); ?>">
            <a href="<?php echo e(isset($menu->url) ? url($menu->url) : 'javascript:void(0);'); ?>" class="<?php echo e(isset($menu->submenu) ? 'menu-link menu-toggle' : 'menu-link'); ?>" <?php if(isset($menu->target) and !empty($menu->target)): ?> target="_blank" <?php endif; ?>>
                <?php if(isset($menu->icon)): ?>
                <i class="<?php echo e($menu->icon); ?>"></i>
...
<?php /**PATH /home/u493167285/domains/totalsporteky.com/public_html/resources/views/layouts/sections/menu/verticalMenu.blade.php ENDPATH**/ ?>